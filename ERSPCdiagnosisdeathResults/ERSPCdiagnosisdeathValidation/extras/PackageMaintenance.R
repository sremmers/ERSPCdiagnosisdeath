...
#
# This file is part of ERSPCdiagnosisdeathValidation
#
...
OhdsiRTools::checkUsagePackage("ERSPCdiagnosisdeathValidation")
OhdsiRTools::updateCopyrightYearFolder()

# Create manual -----------------------------------------------------------
shell("rm extras/ERSPCdiagnosisdeathValidation.pdf")
shell("R CMD Rd2pdf ./ --output=extras/ERSPCdiagnosisdeathValidation.pdf")
...
OhdsiRTools::insertEnvironmentSnapshotInPackage("ERSPCdiagnosisdeathValidation")
