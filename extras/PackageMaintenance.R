...
OhdsiRTools::checkUsagePackage("ERSPCdiagnosisdeath")
OhdsiRTools::updateCopyrightYearFolder()

# Create manual -----------------------------------------------------------
shell("rm extras/ERSPCdiagnosisdeath.pdf")
shell("R CMD Rd2pdf ./ --output=extras/ERSPCdiagnosisdeath.pdf")
...
OhdsiRTools::insertCohortDefinitionSetInPackage(fileName = "CohortsToCreate.csv",
                                                ...
                                                generateStats = FALSE,
                                                packageName = "ERSPCdiagnosisdeath")
...
OhdsiRTools::insertEnvironmentSnapshotInPackage("ERSPCdiagnosisdeath")
